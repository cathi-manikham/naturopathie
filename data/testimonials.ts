export const testimonials = [
  {
    ...
    review: `J’ai beaucoup aimé l’écoute bienveillante de Mme Manikham. Les conseils formulés sont très détaillés et couvrent de nombreux domaines: alimentation, sommeil, transpiration… . Les bons choixen matière d’alimentation ou plus généralement d’hygiène sont préférés aux compléments alimentaires.
        ...
        J’ai enfin réussi à réduire drastiquement la quantité de café ingérée en une journée, ce beaucoup plus facilement que je ne l’imaginais, et j’en ressens un réel bien-être. Mes crampes récurrentes ont aussi grandement diminué ainsi que mes accès de rhizarthrose.
  ...
  },
  {
    ...
    Sur conseil avisé, j’ai contacté Catherine, qui m’a reçue, fait un bilan et proposé un rééquilibrage en fonction de ce que j’aime.

    Au bout de 3 semaines, les premiers effets sont arrivés! Et cela continue.

    Merci à Catherine pour son temps, ses précieux conseils et sa bienveillance!`,
  },
  {
    id: 3,
    name: "Fabrice",
    ...
    Dès les premières minutes, Catherine a décelé à l’œil nu des problèmes de santé que moi seul connaissais. Elle a ensuite pris le temps d’en savoir plus sur mon hygiène de vie. J’ai par la suite changé mon alimentation grâce à ses recommandations.

    Je me sens désormais beaucoup mieux. Je continuerai à la consulter au moins une fois par an.`,
  },
  {
    id: 4,
    name: "Florianne",
    ...
    Un peu dubitative dans un premier temps, je dois reconnaître que les migraines qui me faisaient souffrir depuis des années, ont fortement diminué et par conséquent, ma prise de médicaments aussi.
